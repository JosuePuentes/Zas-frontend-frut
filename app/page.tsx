...
export default function DashboardPage() {
  ...
  const financialCards = [
    ...
    {
      title: 'Batidos Vendidos',
      value: batidosVendidos.toString(),
      icon: ShoppingBag,
  ...
  const COLORS = ['#FF6B6B', '#7CB342', '#9B59B6', '#FF8C42', '#FFB347', '#6B2D5C', '#FC6C85', '#C5E17A'];
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-xl p-6 border border-frutal-mango/20"
        >
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={masVendidos}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey="cantidad_vendida" fill="#9B59B6" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ) : (
              ...
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    ...
                    cy="50%"
                    outerRadius={100}
                    label={({ nombre_batido, cantidad_vendida }) =>
                      `${nombre_batido}: ${cantidad_vendida}`
                    }
                  >
                    {masVendidos.map((_, i) => (
